...
const PropHouseWidgetPage: NextPage<{ data: any }> = (props) => {
  const { data } = props
  ...
  return (
    <div className="font-sans text-black-text flex flex-col h-screen">
      ...
      <main>
        <InstallInstructions
          widget={data}
          familyIcon="/img/icons/prop-house.png"
          propHouse={true}
        />
      </main>
...
export const getStaticProps: GetStaticProps = async (context) => {
  const widget = widgets.propHouse.find((e) => e.slug === context.params!.slug)
...
export const getStaticPaths: GetStaticPaths = async () => {
  const paths: any[] = widgets.propHouse.map((e) => {
...
export default PropHouseWidgetPage
