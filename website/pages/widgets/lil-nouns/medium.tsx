...
const LilNounsMedium: NextPage = () => {
  const data = {
    title: 'Lil Nouns Auction and Governance Widget',
    description: 'Keep an eye on lil nouns auction and active props',
    widgetIconImage: '/img/widgets/lil-nouns/medium/icon.png',
    widgetPromoImage: '/img/widgets/lil-nouns/medium/main.png',
    widgetCode: '/widgets/code/lil-nouns/medium.txt'
  }

  const meta = {
    title: 'Lil Nouns Auction and Governance Widget',
    description: 'Keep an eye on lil nouns auction and active props',
    shareImage: 'https://iamng.wtf/img/widgets/lil-nouns/medium/main.png',
    url: 'https://iamng.wtf/widgets/lil-nouns/medium',
    twitterShare:
      'http://twitter.com/share?text=Want to keep an eye on lil nouns auction and active props?%0a%0aGet yourself the widget!&url=https://iamng.wtf/widgets/lil-nouns/medium'
  }
